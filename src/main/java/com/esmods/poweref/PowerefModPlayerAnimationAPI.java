...
import com.esmods.poweref.network.LoadPlayerAnimationMessage;

public class PowerefModPlayerAnimationAPI {
	...
	private static class AnimationLoader {
		...
		public static void loadAnimations(PlayerEvent.PlayerLoggedInEvent event) {
			if (PowerefModPlayerAnimationAPI.initialized.get(event.getEntity().getUUID()) == null) {
				if (event.getEntity() instanceof ServerPlayer player) {
					PowerefModPlayerAnimationAPI.initialized.put(player.getUUID(), true);
