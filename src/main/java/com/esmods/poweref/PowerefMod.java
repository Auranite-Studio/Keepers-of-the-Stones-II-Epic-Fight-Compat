...
@Mod("poweref")
public class PowerefMod {
	public static final Logger LOGGER = LogManager.getLogger(PowerefMod.class);
	public static final String MODID = "poweref";

	public PowerefMod(IEventBus modEventBus) {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		NeoForge.EVENT_BUS.register(this);
		modEventBus.addListener(this::registerNetworking);
		// Start of user code block mod init
		if (ModList.get().isLoaded("poweref")) {
			ICompatModule.loadCompatModule(modEventBus, EpicFightCompatLayer.class);
		}
